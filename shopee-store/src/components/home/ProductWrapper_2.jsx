...
const ProductWrapper_2 = () => {
    ...
    return (
        <>
            ...
            <div
                className="banner banner-radius banner-wrapper mb-10"
                data-animation-options="{'name': 'fadeIn'}"
                style={{
                    backgroundImage: 'url(images/demos/demo-market2/banner/7.jpg)',
            ...
            >
                <div className="banner-content d-flex align-items-center justify-content-end">
                    <h3 className="banner-title font-secondary font-weight-bold text-uppercase text-center mb-0 ls-m">
                        Gift <span className="text-secondary">50% Off</span> Perfect Styles
                        <br />
                        <span className="banner-text font-primary font-weight-normal text-normal ls-normal d-inline-block">Only until the end of this week</span>
                        <span className="banner-text font-primary font-weight-normal text-normal ls-normal">. Terms and conditions apply</span>
                    </h3>
                    <a href="market2-shop.html" className="btn btn-white btn-rounded">
                        Discover Now
